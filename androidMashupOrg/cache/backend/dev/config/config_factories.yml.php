...
$logger = new sfFileLogger($this->dispatcher, array_merge(array('auto_shutdown' => false), array (
  'level' => 'debug',
  'file' => '/var/www/mashup/log/backend_dev.log',
)));
$this->factories['logger']->addLogger($logger);
  ...
  'cache_dir' => '/var/www/mashup/cache/backend/dev/i18n',
  'lifetime' => 31556926,
  'prefix' => '/var/www/mashup/apps/backend/i18n',
));
  ...
  $class = sfConfig::get('sf_factory_routing', 'sfPatternRouting');
      $cache = new sfFileCache(array (
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/mashup/cache/backend/dev/config/routing',
  'lifetime' => 31556926,
  'prefix' => '/var/www/mashup/apps/backend/routing',
));
...
'auto_shutdown' => false, 'session_id' => $this->getRequest()->getParameter('symfony'),
  ...
  'automatic_cleaning_factor' => 0,
  'cache_dir' => '/var/www/mashup/cache/backend/dev/template',
  'lifetime' => 86400,
  'prefix' => '/var/www/mashup/apps/backend/template',
)));
