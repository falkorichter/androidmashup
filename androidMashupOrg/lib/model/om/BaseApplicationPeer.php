...
abstract class BaseApplicationPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdApplication', 'Package', 'Name', 'Url', 'Icon', 'ApkUrl', 'DeveloperId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idApplication', 'package', 'name', 'url', 'icon', 'apkUrl', 'developerId', ),
		BasePeer::TYPE_COLNAME => array (self::ID_APPLICATION, self::PACKAGE, self::NAME, self::URL, self::ICON, self::APK_URL, self::DEVELOPER_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id_application', 'package', 'name', 'url', 'icon', 'apk_url', 'developer_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdApplication' => 0, 'Package' => 1, 'Name' => 2, 'Url' => 3, 'Icon' => 4, 'ApkUrl' => 5, 'DeveloperId' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idApplication' => 0, 'package' => 1, 'name' => 2, 'url' => 3, 'icon' => 4, 'apkUrl' => 5, 'developerId' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::ID_APPLICATION => 0, self::PACKAGE => 1, self::NAME => 2, self::URL => 3, self::ICON => 4, self::APK_URL => 5, self::DEVELOPER_ID => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('id_application' => 0, 'package' => 1, 'name' => 2, 'url' => 3, 'icon' => 4, 'apk_url' => 5, 'developer_id' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
