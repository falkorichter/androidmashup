...
abstract class BaseApplicationPeer {
	...
	/** the column name for the ID_APPLICATION field */
	const ID_APPLICATION = 'application.ID_APPLICATION';

	/** the column name for the PACKAGE field */
	const PACKAGE = 'application.PACKAGE';
	...
	const APK_URL = 'application.APK_URL';

	/** the column name for the DEVELOPER_ID field */
	const DEVELOPER_ID = 'application.DEVELOPER_ID';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('IdApplication', 'Package', 'Name', 'Description', 'Url', 'Icon', 'ApkUrl', 'DeveloperId', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idApplication', 'package', 'name', 'description', 'url', 'icon', 'apkUrl', 'developerId', ),
		BasePeer::TYPE_COLNAME => array (self::ID_APPLICATION, self::PACKAGE, self::NAME, self::DESCRIPTION, self::URL, self::ICON, self::APK_URL, self::DEVELOPER_ID, ),
		BasePeer::TYPE_FIELDNAME => array ('id_application', 'package', 'name', 'description', 'url', 'icon', 'apk_url', 'developer_id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('IdApplication' => 0, 'Package' => 1, 'Name' => 2, 'Description' => 3, 'Url' => 4, 'Icon' => 5, 'ApkUrl' => 6, 'DeveloperId' => 7, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('idApplication' => 0, 'package' => 1, 'name' => 2, 'description' => 3, 'url' => 4, 'icon' => 5, 'apkUrl' => 6, 'developerId' => 7, ),
		BasePeer::TYPE_COLNAME => array (self::ID_APPLICATION => 0, self::PACKAGE => 1, self::NAME => 2, self::DESCRIPTION => 3, self::URL => 4, self::ICON => 5, self::APK_URL => 6, self::DEVELOPER_ID => 7, ),
		BasePeer::TYPE_FIELDNAME => array ('id_application' => 0, 'package' => 1, 'name' => 2, 'description' => 3, 'url' => 4, 'icon' => 5, 'apk_url' => 6, 'developer_id' => 7, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ApplicationPeer::ID_APPLICATION);

		$criteria->addSelectColumn(ApplicationPeer::PACKAGE);
		...
		$criteria->addSelectColumn(ApplicationPeer::ICON);

		$criteria->addSelectColumn(ApplicationPeer::APK_URL);

		$criteria->addSelectColumn(ApplicationPeer::DEVELOPER_ID);
	...
	public static function addInstanceToPool(Application $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = (string) $obj->getIdApplication();
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Application) {
				$key = (string) $value->getIdApplication();
	...
	public static function doCountJoinDeveloper(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ApplicationPeer::DEVELOPER_ID,), array(DeveloperPeer::ID_DEVELOPER,), $join_behavior);
	...
	/**
	 * Selects a collection of Application objects pre-filled with their Developer objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinDeveloper(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
    ...
    foreach (sfMixer::getCallables('BaseApplicationPeer:doSelectJoin:doSelectJoin') as $callable)
    {
      call_user_func($callable, 'BaseApplicationPeer', $c, $con);
		...
		DeveloperPeer::addSelectColumns($c);

		$c->addJoin(array(ApplicationPeer::DEVELOPER_ID,), array(DeveloperPeer::ID_DEVELOPER,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				if (!$obj2) {
					...
					$omClass = DeveloperPeer::getOMClass();
				...
				// Add the $obj1 (Application) to $obj2 (Developer)
      ...
      call_user_func($callable, 'BaseApplicationPeer', $c, $con);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Application) to the collection in $obj2 (Developer)
				$obj2->addApplication($obj1);
  ...
  static public function getUniqueColumnNames()
  {
    ...
    foreach (sfMixer::getCallables('BaseApplicationPeer:doInsert:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($criteria->containsKey(ApplicationPeer::ID_APPLICATION) && $criteria->keyContainsValue(ApplicationPeer::ID_APPLICATION) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ApplicationPeer::ID_APPLICATION.')');
		}
    ...
    foreach (sfMixer::getCallables('BaseApplicationPeer:doUpdate:pre') as $callable)
    {
      ...
      if (false !== $ret)
      {
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(ApplicationPeer::ID_APPLICATION);
			$selectCriteria->add(ApplicationPeer::ID_APPLICATION, $criteria->remove(ApplicationPeer::ID_APPLICATION), $comparison);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			$criteria->add(ApplicationPeer::ID_APPLICATION, (array) $values, Criteria::IN);
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ApplicationPeer::ID_APPLICATION, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ApplicationPeer::DATABASE_NAME);
			$criteria->add(ApplicationPeer::ID_APPLICATION, $pks, Criteria::IN);
