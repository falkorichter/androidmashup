...
public class MashupOrganizer extends TabActivity implements IMashupActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabHost.addTab(tabHost.newTabSpec("apps").setIndicator("apps",
				...
				new Intent(this, MashupTabApplications.class)));

		tabHost.addTab(tabHost.newTabSpec("intents").setIndicator("intents",
				getResources().getDrawable(R.drawable.diagona069)).setContent(
				new Intent(this, MashupTabIntents.class)));

		tabHost.addTab(tabHost.newTabSpec("preferences").setIndicator(
				"preferences",
				getResources().getDrawable(R.drawable.preferences)).setContent(
